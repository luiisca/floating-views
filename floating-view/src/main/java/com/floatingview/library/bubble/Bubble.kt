...
import com.floatingview.library.ComposeLifecycleOwner

open class Bubble(context: Context, root: View?, private val containCompose: Boolean = false) {
     ...
     * - add this line 'if (root.windowToken == null) return' will prevent the view from being
